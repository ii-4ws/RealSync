...
// Figma asset alias (resolved by vite.config.ts alias)
declare module 'figma:asset/4401d6799dc4e6061a79080f8825d69ae920f198.png' {
  const src: string;
  export default src;
}
...
// Versioned package aliases (resolved by vite.config.ts alias)
...
// Other versioned package aliases
